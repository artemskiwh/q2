    ...
    <>
      ...
      <section id="kitchen" className="relative py-16 md:py-24">
        <div className="container-page">
          ...
          <div className="mx-auto mt-14 grid max-w-5xl grid-cols-2 gap-x-6 gap-y-12 sm:gap-x-10 lg:grid-cols-3">
...
function DrinkGroup({ group }: { group: (typeof BAR)[number] }) {
  return (
    <div className="border border-black/15 bg-black/[0.02] px-6 py-7">
      <div className="mb-5 flex items-baseline justify-between gap-3 border-b border-black/15 pb-3">
        <h3 className="serif-thin text-lg tracking-[0.14em] text-black md:text-xl">
          {group.title}
        </h3>
        {group.note && (
