...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    date: "19 июня 2026",
    text: "😍 однозначно лучшее место в городе! кухня просто 10/10!!",
    visits: "1 посещение",
  },
  {
    name: "Элла Фадеева",
    ...
    date: "6 октября 2025",
    edited: true,
    text: "Ходим сюда постоянно. Как же долго мы искали по всему городу достойный ресторан.",
    visits: "2 посещения",
  },
  {
    name: "Яна Пиктурно",
    ...
    date: "31 июля 2025",
    text: "Очень вкусная кухня и очень приятный персонал!",
    visits: "1 посещение",
  },
  {
    ...
    date: "11 июня 2025",
    edited: true,
    text: "Посетили данное заведение. Приятная атмосфера. Очень вкусные блюда, особенно понравились хинкали и хачапури.",
    visits: "1 посещение",
  },
  {
